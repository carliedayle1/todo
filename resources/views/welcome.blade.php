                                ...
                                <tbody class="divide-y divide-gray-200 dark:divide-neutral-700">
                                    @foreach($todos as $todo)
                                        <tr>
                                            ...
                                            <a href="{{ route('todo.editOrUpdate', $todo->id) }}" class="inline-flex items-center gap-x-2 text-sm font-semibold text-yellow-600 hover:text-yellow-800 dark:text-yellow-500 dark:hover:text-yellow-400">Edit</a>         
