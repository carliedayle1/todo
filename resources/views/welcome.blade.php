              ...
              <div class="p-1.5 min-w-full inline-block align-middle">
                <div class="overflow-hidden">
                  <table class="min-w-full divide-y divide-gray-200 rounded- lg">
                    ...
                    <tr class="odd:bg-white-100 even:bg-gray-100">
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-white">{{ $todo->id }}</td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-white">{{ $todo->title }}</td>
                        <td class="px-6 py-4 whitespace-normal text-sm text-gray-800 dark:text-white break-words">{{ $todo->description }}</td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-white">{{ $todo->completed ? "Yes" : "No" }}</td>
