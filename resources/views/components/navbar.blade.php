...
<header class="flex flex-wrap md:justify-start md:flex-nowrap z-50 w-full py-7 bg-white dark:bg-gray-800 shadow-md">
    <nav class="relative max-w-7xl w-full flex flex-wrap md:grid md:grid-cols-12 items-center px-4 md:px-6 md:px-8 mx-auto">
        <div class="md:col-span-3">
            <!-- Logo -->
            <a class="flex-none rounded-xl text-xl inline-block font-semibold text-gray-800 dark:text-white focus:outline-none focus:opacity-80" href="/" aria-label="Todo">
                Todo
            </a>
            <!-- End Logo -->
        </div>
        ...
        <div id="hs-navbar-hcail" class="hs-collapse hidden overflow-hidden transition-all duration-300 basis-full grow md:block md:w-auto md:basis-auto md:order-2 md:col-span-6" aria-labelledby="hs-navbar-hcail-collapse">
            <div class="flex flex-col gap-y-4 gap-x-0 mt-5 md:flex-row md:justify-center md:items-center md:gap-y-0 md:gap-x-7 md:mt-0">
                <x-navlink name="home" class="hover:text-teal-500 transition duration-300">Home</x-navlink>
                <x-navlink name="about" class="hover:text-teal-500 transition duration-300">About</x-navlink>
                <x-navlink name="contact" class="hover:text-teal-500 transition duration-300">Contact</x-navlink>
            </div>
        </div>
        <!-- End Collapse -->
    </nav>
