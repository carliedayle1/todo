<x-layout>
  ...
  <div class="relative mb-5">
    ...
    autofill:pt-6
    autofill:pb-2" placeholder="Title here" value="{{ old('title') ? old('title'): $todos->title}}">
...
<div class="max-w-sm space-y-5">
  ...
  <div class="relative">
    ...
    [&:not(:placeholder-shown)]:pb-2
    autofill:pt-6
    autofill:pb-2" placeholder="This is a textarea placeholder" rows="10">{{ old('description') ? old('description'):$todos->description}}</textarea>
...
<div class="relative">
  ...
  autofill:pt-6
  autofill:pb-2">
    <option {{ $todos->completed ? 'selected':''}}">Yes</option>
    <option {{ !$todos->completed ? 'selected':''}}>No</option>
  </select>
